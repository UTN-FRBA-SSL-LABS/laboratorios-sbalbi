...
> R:La funcion inicializa el carrito en cero. Es importante porque de no usarla pueden quedar datos basura en esa direccion, lo que interferiria en el desarrollo.   
...
> R:Deberia multiplicar el producto por la cantidad del mismo.
...
> R:Si la linea 29 y la 30. Porque no existe ningun test unitario que la invoque.
...
> R:El test unitario prueba una función aislada , mientras que el de integración prueba cómo interactúan múltiples funciones. Lo detecto primero el test unitario.
...
> R:Porque en c no hay verificacion de limites, lo que permite sobrescribir la memoria. Mientras que en esos lenguajes hay chequeos automaticos que no permiten acceder a memoria invalida. 
...
> R:Al usar una cantidad de 1 producto, la multiplicación precio x cantidad da el mismo valor que tomar únicamente el precio. Por esa coincidencia matemática, la falla en el código no se detecta y pasa. 
